...
- [Mouse & Keyboard Filter Drivers](https://learn.microsoft.com/en-us/windows/win32/fwp/windows-filtering-platform-start-page) - Mouse & keyboard filter drivers for the Windows kernel, enabling low-level interception and manipulation of user input, using the Windows Filtering Platform (WFP).
