...
- [SharpVNC](https://github.com/sharpvnc/SharpVnc.Core) - a .NET implemenetation of a [Remote Framebuffer Protocol (RFB)](https://tools.ietf.org/html/rfc6143) client & server. This will now be licensed proprietary for binary distributions only.
